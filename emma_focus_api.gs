...
function initData() {
  ...
  const timelineData = [
    ...
    ["2026-06-27", "周六", "10:24", "11:11", "自主高效", 1, 0, "早间长效专注", false, 0],
    ["2026-06-27", "周六", "11:21", "12:01", "亲子互动", 0, 0, "亲子辅导互动", false, 0],
    ["2026-06-27", "周六", "16:45", "17:40", "自主高效", 1, 1, "下午全天高能突破", false, 0]
  ];
