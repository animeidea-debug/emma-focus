...
TABLE_HEADERS = {
    ...
    "tmos_reward_settlements": "Settlement_ID,User,Settlement_Type,Source_Event_IDs,Star_Credit_Milli_Delta,Silver_Delta,Gold_Delta,Policy_Version,Created_At,Reversed_Settlement_ID,Wallet_Transaction_ID",
}
