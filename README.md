...
| 摄像头 | 源编码 | 源分辨率 | 输出编码 | 输出分辨率 | 倍速 |
|--------|--------|---------|---------|---------|------|
| 书房主机位 | H.265 (HEVC) | 原始 4K (3840×2160) | H.264 (h264_qsv) | 720P (1280×720) | 30x |
| 书房辅机位 | H.265 (HEVC) | 原始 4K (3840×2160) | H.264 (h264_qsv) | 1080P (1920×1080) | 30x |
| 客厅 | H.265 (HEVC) | 原始 4K (3840×2160) | H.264 (h264_qsv) | 4K (3840×2160) | 30x |

> **说明：** 所有摄像头源视频均为 H.265 (HEVC) 编码的 4K 画面。输出统一使用 Intel QSV 硬件加速的 H.264 编码，通过 `-2:HEIGHT` 保持原始宽高比。书房主/辅机位降分辨率输出以节省空间，客厅保留 4K 原分辨率。
